...
<aside style="padding:16px 24px;background:#8ea2ff;color:#0b1420;text-align:center;font:14px/1.6 system-ui">
<strong>Explore a sample digest.</strong> All prices, news, AI summaries, and earnings below are illustrative, not live data.
<a href="/" style="color:#0b1420;font-weight:700;margin-left:12px">Back to Tickr Digest →</a>
</aside>''', 1)
