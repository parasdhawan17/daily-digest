...
AI_STOCK_OVERVIEW_MAX_OUTPUT_TOKENS = int(
    os.environ.get("AI_STOCK_OVERVIEW_MAX_OUTPUT_TOKENS", "1200")
)
AI_STOCK_SECTION_MAX_OUTPUT_TOKENS = int(
    os.environ.get("AI_STOCK_SECTION_MAX_OUTPUT_TOKENS", "500")
)
