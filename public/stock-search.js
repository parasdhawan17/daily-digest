(function () {
  ...
  dialog.innerHTML = '<div class="stock-search-heading"><h2 id="stock-search-title">Find your next perspective.</h2><button class="stock-search-close" aria-label="Close stock search" type="button">×</button></div><div class="stock-search-input-wrap"><input type="search" aria-label="Search Indian stocks by name or symbol" placeholder="Company or symbol, e.g. TCS" role="combobox" aria-autocomplete="list" aria-expanded="false" aria-controls="stock-search-results" autocomplete="off" maxlength="100"></div><p class="stock-search-status" role="status">Search companies listed in India.</p><ul id="stock-search-results" class="stock-search-results" role="listbox" aria-label="Stock results"></ul>';
